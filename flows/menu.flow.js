...
const flows = {
    ...
    "C": createFlow("C", ["💰 *Valores de cuota social:*", "🔹 ACTIVOS $40,000", "🔹 CAD.ACTIVO $37,300", "📆 Fecha de pago: 01 al 20."]),
    "D": createFlow("D", ["🎟️ *Valores de entrada a NO SOCIOS*", "🔹 Mayores de 12 años: $7,000", "🚗 Estacionamiento: $3,000"]),
    "E": createFlow("E", ["👨‍👩‍👧‍👦 *Grupo familiar:* Padre, madre y 2 hijos (6-17 años)."]),
    "F": createFlow("F", ["🕒 *Horario de Secretaría*", "🔹 Lunes a Viernes: 11:00 - 19:00", "🔹 Sábados: 08:00 - 11:30"]),
    "G": createFlow("G", ["🏋️ *Horario de Gimnasio*", "🔹 Lunes a Viernes: 07:00 - 21:00", "⚠️ Feriados nacionales: CERRADO"]),
    ...
    "J": createFlow("J", ["💡 *Fichas de Luz Canchas*", "⚽ Fútbol: $15,000", "🎾 Tenis: $4,000"]),
    "K": createFlow("K", ["🏕️ *Carpas y Casas Rodantes*", "🔹 Socios: $5,000/noche", "🚐 Casa Rodante No Socio: $18,000"]),
    "L": createFlow("L", ["🎓 *Becas Municipales*", "📅 Se entregan a partir del 10 de febrero."]),
    "M": createFlow("M", ["🏠 *Quinchos*", "🔹 Pileta: Uso común socios", "🔹 Tejo: Alquiler (Info en secretaría)"]),
    "N": createFlow("N", ["🏅 *Deportes:* Consultar en secretaría."]),
    "O": createFlow("O", ["🛍️ *Showroom*", "📅 Lunes a Viernes: 16:30 - 20:30", "🚫 Domingo y Feriados: CERRADO"])
};
