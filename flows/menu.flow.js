...
const flows = {
  ...
  "C": createFlow("C", [
    ...
    "E": createFlow("E", ["👨‍👩‍👧‍👦 *Grupo familiar:* Padre, madre y 2 hijos (6-17 años). Presentando constancia de alumno regular todos los años puede permanecer dentro del grupo hasta los 24 años inclusive "]),
    "F": createFlow("F", [
    ...
    "H": createFlow("H", ["🏊 *Horario Pileta Climatizada*", "🔹 Lunes a Viernes: 17:00 - 21:00" , "🔹 Sabado: 11:00 - 15:00 y de 18:00 a 12:00" ,"🔹 Domingo: 11:00 - 16:00" , "⚠️ Feriados nacionales: CERRADO", "⚠️ Telefono Pileta: 3364 074795" ]),
   ...
   "L": createFlow("L", [
    ...
    "M": createFlow("M", [
        "🏠 *Quinchos*",
        "🔹 Pileta: QUINCHO DE TENIS ES DE USO LIBERADO DE LUNES A JUEVES A PARTIR DE LAS 19 HS VIERNES, SABADO , DOMINGO Y FERIADOS SE ALQUILA",
    ...
    "   - Sin costo, uso compartido (solo días hábiles)",
    "   - *Se podrá alquilar con anticipación en cualquier turno*",
    "     Ese día se publicará que no estará disponible para uso común",
    "   - Valor del alquiler anticipado: $80.000",
    "",
    "▪️ Viernes",
    ...
    "   Mesas y sillas extras corren por cuenta del inquilino.",
    "",
    "⚠️ No se extiende el horario.",
    "⚠️ No se pueden pegar decoraciones.",
    "⚠️ Siempre habrá un encargado hasta la hora de cierre.",
    "",
    "📌 Reservas: por orden de llegada en secretaría.",
    "(No se realizan descuentos por doble turno).",
    ]),
    "N": addKeyword("R")
